...
<%@include file="../includes/header.jsp" %>
    ...
    <!-- Begin Page Content -->
				...
				<div>
                	<h1><span class="badge badge-pill badge-info">READ PAGE</span></h1>
				</div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control bno" name="title" value="<c:out value="${board.bno}"></c:out>" readonly="readonly">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">TITLE</label>
    <input type="text" class="form-control" name="title" value="<c:out value="${board.title}"></c:out>" readonly="readonly">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">CONTENT</label>
    <input type="text" class="form-control" name="title" value="<c:out value="${board.content}"></c:out>" readonly="readonly">
  </div>
  
  <div class="form-group">
    <label for="exampleFormControlInput1">WRITER</label>
    <input type="text" class="form-control" name="title" value="<c:out value="${board.writer}"></c:out>" readonly="readonly">
  </div>
